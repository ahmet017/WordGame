...
namespace WordLink
{
	public class LevelCompletePopup : dotmob.Popup
	{
		...
		public override void OnShowing(object[] inData)
		{
			...
			levelText.text				= string.Format(API.GetText(WordIDs.LevelCompletePopup_CompleteText), level.levelData.GameLevelNumber);
			//gamePointsText.text			= currentGamePoints.ToString();
			nextLevelButtonText.text	= isLastLevel ? "Home" : string.Format(API.GetText(WordIDs.LevelCompletePopup_NextButton));
			...
			else
			{
				...
				extraWordsText.text				= string.Format(API.GetText(WordIDs.LevelCompletePopup_ExtraWordsText), extraWordsCoinsAwarded);
